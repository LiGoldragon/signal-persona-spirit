...
| Every submitted entry is one top-level psyche statement without client-provided capture time. | `Entry` carries one or more topics, kind, description, and optional certainty; repeated entries are the restatement signal. |
